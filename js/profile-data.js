                ...
                profilesOfYear +=
                    ...
                    <div class="path hover-container card" style="background-image:url(./images/pic-${profileData[year][person].name.split(" ").join("").toLowerCase()}.jpg);">
                        ...
                        <div class="hover-content">
                            ...
                            <div><a href="${profileData[year][person].url}.html" class="button btn-blue">View Profile <span><i class="fas fa-arrow-right"></i></span></a></div>
                        </div>
                    </div>
                `
            };
